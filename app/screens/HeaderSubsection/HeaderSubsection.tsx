...
export default function HeaderSubsection  ()  {
  ...
  <motion.a
    ...
    whileHover={{ x: 5 }}
    className="text-left px-4 py-4 text-white font-karla text-[18px] hover:bg-white/10 transition-all duration-300"
  >
    {item.label}
  </motion.a>
))}
              ...
              <div className="p-4">
                <img 
                  src="/nav-btn.png" 
                  className="w-[120px] h-[44px] object-contain cursor-pointer transform transition-transform duration-300 hover:scale-90  hover:opacity-80" 
                  alt="Login" 
                  onClick={() => {
